...
import { IPodItem } from 'src/pages/Deployment/type';
import { PRODUCT_STOCK_OPTIONS } from 'src/_mock/_product';
import { useGetPods, useScaleDeployment } from 'src/api/deployment';
...
export default function ProductListView() {
  ...
  const columns: GridColDef[] = [
    ...
    },
    {
      ...
      headerName: 'IsReady',
      // width: 160,
      renderCell: (params) => <RenderCellIsReady params={params} />,
    },
...
function applyFilter({
  ...
  if (publish.length) {
    inputData = inputData.filter((deployment) => publish.includes(deployment.IsReady.toString()));
  }
